...
// CHECK-LABEL: func @store_to_load_tensor_perm
//  CHECK-SAME: (%[[ARG:.*]]: tensor<4x4x4xf32>, %[[V0:.*]]: vector<4x1xf32>)
//  CHECK-NEXT:   %[[T:.*]] = vector.transpose %[[V0]], [1, 0] : vector<4x1xf32> to vector<1x4xf32>
//       CHECK:   return %[[T]] : vector<1x4xf32>
func.func @store_to_load_tensor_perm_broadcast(%arg0 : tensor<4x4x4xf32>,
  %v0 : vector<4x1xf32>) -> vector<1x4xf32> {
  %c0 = arith.constant 0 : index
  %cf0 = arith.constant 0.0 : f32
  ...
  %0 = vector.transfer_read %w0[%c0, %c0, %c0], %cf0 
      {in_bounds = [true, true],
