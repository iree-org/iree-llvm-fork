...
#map1 = affine_map<(d0, d1, d2) -> (d0, d1, d2)>
func.func @vectorize_nd_tensor_extract_transfer_read_easy(%arg0: tensor<3x3x3xf32>, %arg2: tensor<1x1x3xf32>) -> tensor<1x1x3xf32> {
  %1 = linalg.generic {
    indexing_maps = [#map1],
    iterator_types = ["parallel", "parallel", "parallel"]
  } outs(%arg2 : tensor<1x1x3xf32>) {
...
// CHECK-LABEL: func.func @vectorize_nd_tensor_extract_transfer_read_easy
...
// CHECK:           return %[[VAL_24]] : tensor<?x?xf32>
// CHECK:         }
