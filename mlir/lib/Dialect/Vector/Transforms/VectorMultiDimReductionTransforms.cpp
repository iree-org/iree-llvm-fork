...
#include "mlir/Dialect/Vector/Transforms/VectorMaskingUtils.h"
...
public:
  ...
  LogicalResult matchAndRewrite(vector::MultiDimReductionOp multiReductionOp,
    ...
    newMultiRedOp =
        vector::utils::maskOperation(rewriter, newMultiRedOp, transposedMask);
...
public:
  ...
  LogicalResult matchAndRewrite(vector::MultiDimReductionOp multiReductionOp,
    ...
    newMultiDimRedOp =
        vector::utils::maskOperation(rewriter, newMultiDimRedOp, newVectorMask);
  ...
  LogicalResult matchAndRewrite(vector::MultiDimReductionOp multiReductionOp,
    ...
    for (int i = 0; i < outerDim; ++i) {
      ...
      if (maskableOp.isMasked()) {
        ...
        reductionOp = vector::utils::maskOperation(rewriter, reductionOp, mask);
      }
