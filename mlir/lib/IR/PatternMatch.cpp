...
void RewriterBase::mergeBlockBefore(Block *source, Block *dest,
...
void RewriterBase::mergeBlockBefore(Block *source, Operation *op,
                                    ValueRange argValues) {
  mergeBlockBefore(source, op->getBlock(), op->getIterator(), argValues);
}

void RewriterBase::mergeBlocks(Block *source, Block *dest,
                               ValueRange argValues) {
  mergeBlockBefore(source, dest, dest->end(), argValues);
}
