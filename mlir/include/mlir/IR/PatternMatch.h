...
public:
  ...
  /// Merge the operations of block 'source' to block 'dest' before the given
  ...
  void mergeBlockBefore(Block *source, Block *dest, Block::iterator before,
                        ValueRange argValues = std::nullopt);

  /// Merge the operations of block 'source' before the operation 'op'. The
  ...
  /// Merge the operations of block 'source' into the end of block 'dest'. The
  /// source block will be deleted and must have no uses. 'argValues' is used to
  /// replace the block arguments of 'source'
  ///
