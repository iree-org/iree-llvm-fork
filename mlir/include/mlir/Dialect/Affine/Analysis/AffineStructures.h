...
/// FlatAffineValueConstraints is an extension of FlatValueConstraints with
/// helper functions for Affine dialect ops.
class FlatAffineValueConstraints : public FlatValueConstraints {
public:
  using FlatValueConstraints::FlatValueConstraints;
  ...
  LogicalResult addBound(BoundType type, unsigned pos, AffineMap boundMap,
                         ValueRange operands);
  using FlatValueConstraints::addBound;
